    ...
    <div className="w-full max-w-5xl mx-auto px-6 py-20">
      <div className="flex flex-col items-center text-center mb-24 space-y-8">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-zinc-900 dark:text-white max-w-4xl">
          ...
          <span className="text-zinc-500 dark:text-zinc-400">Authentic Video.</span>
        </h1>
        
        <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl leading-relaxed font-light">
          Immerse yourself in content you love. Interactive translations, personalized vocabulary, and smart progress tracking.
        </p>
      </div>
        ...
        <div className="group relative">
           <div className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-zinc-900 dark:focus-within:ring-zinc-100 focus-within:border-transparent">
            <form onSubmit={handleSubmit} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 px-6 py-3 rounded-xl font-medium transition-all flex items-center gap-2"
                >
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <FeatureCard 
           ...
           description="Watch videos with synchronized bilingual subtitles that keep you engaged."
        />
        <FeatureCard 
           icon={<CheckCircle2 className="w-5 h-5" />}
           title="Smart Vocabulary"
           description="Click any word to save it. We'll track what you're learning automatically."
        />
      </div>
    </div>
  );
